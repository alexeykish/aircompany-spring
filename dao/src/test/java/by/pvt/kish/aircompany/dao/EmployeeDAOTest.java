...
public class EmployeeDAOTest {
    ...
    public  void testEmployeeAvailability() throws Exception {
        ...
        assertTrue("Expected false, but failed" , employeeDao.checkEmployeeAvailability(id, testDate1));
        Date testDate2 = new Date(System.currentTimeMillis() + 1000L * 60L * 60L * 24L * 2);
        assertFalse("Expected false, but failed" , employeeDao.checkEmployeeAvailability(id, testDate2));
    }
